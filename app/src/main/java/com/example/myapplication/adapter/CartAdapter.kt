...
class CartAdapter(
    ...
    private val onItemClicked: (CartResponseData) -> Unit
) :
    ListAdapter<CartResponseData, CartAdapter.ItemViewHolder>(DiffCallBack) {
    inner class ItemViewHolder(var binding: CartProductVisualBinding) :
            ...
            binding.apply {
                ...
                binding.removeFromCart.setOnClickListener {
                    ...
                    (activity as HomeScreen).showAlert(
                        ...
                        if (it) {
                            if (data.productDetails.isFirebaseProduct == true) {
                                viewModel.removeProductFromFirebaseCart(data.productDetails._id?:"") {
                                    if (it) {
    ...
    companion object {
        private val DiffCallBack = object : DiffUtil.ItemCallback<CartResponseData>() {
            override fun areItemsTheSame(
                oldItem: CartResponseData,
                newItem: CartResponseData
            ): Boolean {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        return ItemViewHolder(
            CartProductVisualBinding.inflate(
